...
server <- function(input, output, session) {
  ...
  observeEvent(input$auswahl_suchen,{
    output$gcsAugePlot <- renderPlot({ggplot(data =  gcs_selected()) +
    ...
    output$gcsVerbalPlot <- renderPlot({ggplot(data =  gcs_selected()) +
    ...
    output$gcsMotorischPlot <- renderPlot({ggplot(data =  gcs_selected()) +
    ...
    output$gcsTotalPlot <- renderPlot({ggplot(data =  gcs_selected()) +
